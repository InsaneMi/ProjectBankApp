...
<head>
    ...
    <style>
        body{
           background-image: url('https://images.pexels.com/photos/164501/pexels-photo-164501.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');
...
<body>
         ...
         <div class="row">
              ...
              <div class="col m6 offset-m3">
                   ...
                   <div class="card">
                        ...
                        <div class="card-action deep yellow white-text">
                              <h3 style="margin-top:10px;" class="center-align">Add Card</h3>
                        </div>
                        ...
                        <div class="card-content">
                             ...
                             <div class="form center-align">
                                  ...
                                  <form action="AddCardS" method="post" onsubmit="return validation()">
                                        ...
                                        <!--  
                                        <h6 class="left-align">Enter Card Type</h6>
                                        <input type="text" name="cardtype" placeholder="Character between 5 to 30." id="cardtype" autocomplete="off">
                                        -->
                                        ...
                                        <h6 class="left-align">Enter CVV No.</h6>
                                        <input type="text" name="cardcvv" placeholder="3 Digit number." id="cardcvv" autocomplete="off">
                                        
                                        <h6 class="left-align">Enter Expiry Date</h6>
                                        <input type="text" name="cardexp" placeholder="6 Digit number." id="cardexp" autocomplete="off">
    ...
    <script type="text/javascript">
         function validation()
         {
        	 ...
        	 if(cid=="" || accno=="" || cardno=="" || cardcvv=="" || cardexp=="")
        		 {
	 		...
	 		if((cardno.length < 9) || (cardno.length > 9))
   	 		...
   	 		if(isNaN(cardcvv))
				{
					alert("Card CVV can only be number.");
					return false;
				}
			if((cardcvv.length < 3) || (cardcvv.length > 3))
				{
					alert("Card CVV must be of 3 digit.");
					return false;
				}
			if(isNaN(cardexp))
				{
